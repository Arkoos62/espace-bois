...
import CustomCarouselCss from '../styles/style.css';
                ...
                <TextDiv>
                    <InView threshold={.6}>
                        {({ inView, ref }) => (
                            <TextCell ref={ref} inView={inView}>
                                Nos<br/><strong>Réalisations</strong><br/>

                                <hr/>

                                <span>
                                    Découvrez les chantiers réalisés<br/>
                                    par <strong>Espace Bois</strong>
                                </span>
                            </TextCell>
                        )}
                    </InView>
                    ...
                    <ButtonCell>
                        <ConfigProvider
                            ...
                            <Button href="#galerie" type="link" size="large">
                                Découvrir plus
                            </Button>
                        </ConfigProvider>
                    </ButtonCell>
